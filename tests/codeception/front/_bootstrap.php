...
defined('YII_FRONT_TEST_ENTRY_URL') or define('YII_FRONT_TEST_ENTRY_URL', parse_url(\Codeception\Configuration::config()['config']['test_entry_url'], PHP_URL_PATH));
defined('YII_TEST_FRONT_ENTRY_FILE') or define('YII_TEST_FRONT_ENTRY_FILE', APPS_DIR . '/front/web/index-test.php');

require_once(VENDOR_DIR . '/autoload.php');
require_once(VENDOR_DIR . '/yiisoft/yii2/Yii.php');
require_once(APPS_DIR . '/common/config/bootstrap.php');
require_once(APPS_DIR . '/front/config/bootstrap.php');
