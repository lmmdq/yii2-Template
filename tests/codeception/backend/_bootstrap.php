...
defined('YII_TEST_BACKEND_ENTRY_FILE') or define('YII_TEST_BACKEND_ENTRY_FILE', APPS_DIR . '/backend/web/index-test.php');

require_once(VENDOR_DIR . '/autoload.php');
require_once(VENDOR_DIR . '/yiisoft/yii2/Yii.php');
require_once(APPS_DIR . '/common/config/bootstrap.php');
require_once(APPS_DIR . '/backend/config/bootstrap.php');
