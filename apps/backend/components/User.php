...
class User extends \yii\web\User
{
    ...
    {
        return $this->getIdentity(false) === null;
    }
    ...
    {
        $this->trigger(self::EVENT_AFTER_LOGIN, new \yii\web\UserEvent([
            'identity' => $identity,
            'cookieBased' => $cookieBased,
            'duration' => $duration,
        ]));
    ...
    {
        $this->trigger(self::EVENT_AFTER_LOGOUT, new \yii\web\UserEvent([
            'identity' => $identity,
        ]));
    }
